...
#file_with_view = sys.argv[-2]
output_file = sys.argv[-1]

# display result by rendering an image of estimated viewpoint
#estimated_viewpoints = [[float(x) for x in line.rstrip().split(' ')] for line in open(file_with_view, 'r')]
#v = estimated_viewpoints[0]
v = [0, 0, 0]
print("Estimated view:")
print(v)

camObj = bpy.data.objects['Camera']

cx, cy, cz = obj_centened_camera_pos(1, v[0], v[1])
q1 = camPosToQuaternion(cx, cy, cz)
q2 = camRotQuaternion(cx, cy, cz, v[2])
...
bpy.data.scenes['Scene'].render.filepath = os.path.join(output_file)
